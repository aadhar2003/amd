...
export default function Home() {
  ...
  const exampleData = {
    ...
    description:
      "We bring color to every angle of your daily life in and around your house and workplace.",
    mainImage: "main-product.jpg", // Add main image here
    products: [
      { name: "Furniture", image: "furniture.jpg" },
      { name: "Bottles", image: "bottles.jpg" },
      { name: "Disposable Houseware", image: "plates.jpg" },
      { name: "Buckets & Tubs", image: "buckets.jpg" },

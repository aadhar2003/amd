...
export default function Home() {
  ...
  const exampleData = {
    title: "Electrical",
    description:
      "We provide electrical solutions that are reliable, efficient, and made with high-grade materials.",
    mainImage: "electrical.jpg",
    products: [
      { name: "Wiring Accessories", image: "wiring-accessories.jpg" },
      { name: "Cable Management", image: "cable-management.jpg" },
      { name: "Electrical Enclosures", image: "electrical-enclosures.jpg" },
      { name: "Lighting Fixtures", image: "lighting-fixtures.jpg" },

...
export default function Home() {
  ...
  const exampleData = {
    title: "Packaging",
    description:
      "Our high-quality packaging solutions ensure the safety and durability of your products.",
    mainImage: "packaging.jpg",
    products: [
      { name: "Plastic Bags", image: "plastic-bags.jpg" },
      { name: "Containers", image: "containers.jpg" },
      { name: "Bottles & Caps", image: "bottles-caps.jpg" },
      { name: "Foam Packaging", image: "foam-packaging.jpg" },
      { name: "Stretch Films", image: "stretch-films.jpg" },
    ],
  };

...
export default function Home() {
  ...
  const exampleData = {
    title: "Fibres",
    description:
      "Our fiber-based solutions cater to various industries, ensuring durability and sustainability.",
    mainImage: "fibres.jpg",
    products: [
      { name: "Synthetic Fibers", image: "synthetic-fibers.jpg" },
      { name: "Polyester Yarns", image: "polyester-yarns.jpg" },
      { name: "Textile Fibers", image: "textile-fibers.jpg" },
      { name: "Industrial Fibers" },
      { name: "Recycled Fibers", image: "recycled-fibers.jpg" },
    ],
  };

  ...
  return (
    ...
    >
      ...
      <div className="pt-30 mx-5">
        <MasterbatchProduct
          title="PET Masterbatches"
          imageUrl="/pet-masterbatches.jpg"
          description={[
            "ACC Masterbatch provides high performance PET Master Batches in both resin base as well as a new technology in dustless powder form. This new product in our portfolio branded MinoBatch gives you the advantage of coloring your PET resin at very low dosage and offers excellent dispersion, clarity & gloss.",
            "Our PET Master batches are made using high performance FDA approved and compliant grades of pigments and dyes.",
            "High Performance PET Masterbatches ACC Masterbatch has its forte in manufacturing of PET Masterbatches for the last 5 years. We offer resin as well as dustless powder type Masterbatches for PET. These masterbatches are specifically designed for the PET Bottle industry.",
          ]}
          applications={[
            "The applications of PET Masterbatches is as follows",
          ...
          features={[
              ...
              "FDA approved and compliant grades",
              "Available in resin base and dustless powder form",
              "Very low dosage requirements",
              "Excellent dispersion properties",
              "Superior clarity and gloss",
              "Specially designed for PET bottle industry",
              "5+ years of manufacturing expertise",
            ]
          }
        />
      </div>

...
export default function Home() {
  ...
  const exampleData = {
    title: "Automotive",
    description:
      "Durable and high-performance plastic components for the automotive industry.",
    mainImage: "automotive.jpg",
    products: [
      { name: "Car Bumpers", image: "car-bumpers.jpg" },
      { name: "Dashboard Components", image: "dashboard.jpg" },
      { name: "Headlight Casings", image: "headlight-casings.jpg" },
      { name: "Interior Trims", image: "interior-trims.jpg" },
      { name: "Side Mirrors", image: "side-mirrors.jpg" },
    ],
  };

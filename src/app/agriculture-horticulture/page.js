...
export default function Home() {
  ...
  const exampleData = {
    ...
    description:
      "Enhancing farming and gardening with durable and eco-friendly plastic solutions.",
    mainImage: "agriculture-horticulture.jpg",
    products: [
      { name: "Drip Irrigation Pipes", image: "drip-irrigation.jpg" },
      { name: "Greenhouse Films", image: "greenhouse-films.jpg" },
      { name: "Grow Bags", image: "grow-bags.jpg" },
      { name: "Seedling Trays", image: "seedling-trays.jpg" },
      { name: "Mulch Films" },
    ],
  };

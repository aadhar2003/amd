...
export default function Home() {
  ...
  <MasterbatchProduct
    title="Special Masterbatches"
    imageUrl="/special-masterbatches.jpg"
    description={[
      "ACC Masterbatch specializes in customized Special Masterbatches tailored to meet unique customer requirements across various industries.",
      "These masterbatches provide special effects such as metallic, pearlescent, fluorescent, and glow-in-the-dark properties for premium product aesthetics.",
      "Our advanced formulations ensure superior performance, color stability, and compatibility with different polymers.",
    ]}
    applications={[
      "The applications of Special Masterbatches include:",
      "Luxury Packaging",
    ...
    features={[
      "Special effects like metallic, pearlescent, and fluorescent",
      "Glow-in-the-dark and thermochromic options available",
      "High-quality pigments for superior visual appeal",
      "Excellent compatibility with various polymers",
      "UV and heat resistance for long-term durability",
      "Customizable for unique aesthetic and functional needs",
      "Ideal for premium and high-end applications",
    ]}
  />
</div>
